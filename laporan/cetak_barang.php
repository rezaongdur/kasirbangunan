...
<body onload="window.print()" style="font-family:'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma,  sans-serif;width:21cm;">
		<table width="100%" border="0" cellpadding="2" cellspacing="0">
			<thead>
				<tr>
				 	<td colspan="2"><img src="http://localhost:81/CBT/revisi/Toko Bangunan Damar Putra Damar Putra/img/logo1.png" alt="logo" width="160" height="90"></td>
				 	<td colspan="5">
				 		<h1 style="margin:0">Toko Damar Putra</h1>
				 		<h4 style="margin:0;margin-top:4px;">Jl. Jend. Sudirman, Desa Jatimulya, Kec. Rangkasbitung, Lebak, Banten</h4>
				 	</td>
				</tr>
				...
				<tr>
					...
					<!-- <th  style="border:1px solid black">Laba</th> -->
