<?php  
	...
	//laba
	@$bulanlaba = date("m");
	@$lababulanan = mysql_fetch_array(mysql_query("select sum(a.ppn*c.banyak) as 'labamsk' from tbl_barang a, tbl_transaksi b, tbl_transaksi_detail c where a.kd_barang = c.kd_barang and b.no_transaksi = c.no_transaksi and b.tgl_transaksi='$bulanlaba' AND YEAR(b.tgl_transaksi)='$thn'"));
	@$labapengeluaran = mysql_fetch_array(mysql_query("SELECT SUM(keluar) as 'labaklr' FROM tbl_keuangan WHERE MONTH(tanggal)='$bln' AND YEAR(tanggal)='$thn'"));
	@$labaharian = mysql_fetch_array(mysql_query("select sum(a.ppn*c.banyak) as 'labahari' from tbl_barang a, tbl_transaksi b, tbl_transaksi_detail c where a.kd_barang = c.kd_barang and b.no_transaksi = c.no_transaksi and b.tgl_transaksi = '$tanggal'"));
	@$laba = $lababulanan['labamsk'] - $labapengeluaran['labaklr'];
				...
				<div class="col-lg-3 col-md-6">
				    <div class="panel panel-success">
				        <div class="panel-heading">
				            <div class="row">
				                <div class="col-xs-12 text-right">
				                    <div style="font-size:30px;margin-top:10px;" >Rp. <?php echo number_format($labaharian['labahari'],0,'','.'); ?>,00</div>
				...
				<div class="col-lg-3 col-md-6">
				    <div class="panel panel-info">
				        <div class="panel-heading">
				            <div class="row">
				                <div class="col-xs-12 text-right">
				                    <div style="font-size:30px;margin-top:10px;" >Rp. <?php echo number_format(@$lababulanan['msk'],0,'','.'); ?>,00</div>
				                    <div>Pendapatan Bulanan</div>
				                </div>
				            </div>
				        </div>
