					...
					<div class="panel-body">
						<form method="post">
							 ...
							 <td>
                                <div class="form-group">
                                	<div class="input-group">
	                                    ...
	                                    <input type="text" name="tppn" id="tppn" value="<?php echo @$edit['ppn']; ?>" class="form-control" placeholder="Laba (10%)"  required maxlength="11"  autocomplete="off" tabindex="1">
                            ...
                            <div class="form-group">
								<div class="input-group">
									<span class="input-group-addon"><div class="glyphicon glyphicon-usd"></div></span>
									<input type="text" name="thargajual" id="thargajual" value="<?php echo @$edit['harga_jual']; ?>" placeholder="Harga Jual / Satuan" class="form-control" maxlength="25"length="11" required  tabindex="1" onkeypress="return event.charCode >= 48 && event.charCode <= 57">
								</div>
							</div>
							...
							<div class="table-responsive">
								<table class="table table-hover table-bordered table-striped">
									...
									<tbody>
										<tr>
											<?php  
												$a = $aksi->tampil("qw_barang",$cari," ORDER BY kd_barang DESC limit 10");
												@$no = 0;
												if ($a=="") {
