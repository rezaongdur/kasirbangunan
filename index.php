...
<head>
        ...
        <title>Aplikasi Inventory : Toko Damar Putra</title>
...
<!--  background-color:#deecdf;  hijau muda pastel-->
	<div class="container">
		<div class="col-md-3" background-color="#323b44"></div>
		<div class="col-md-6">
			<div class="panel panel-primary" style="margin-top:120px;">
				<div class="panel-heading" style="padding:20px;">
					<div class="col-md-1"></div>
					<div style="font-size:200%;"><strong>Toko Damar Putra</strong></S></div>
					<div class="col-md-1"></div>
				...
				<div class="panel-footer" align="center">
						&copy;<?php echo date('l, d-m-Y'); ?> - Design by RezaR
				</div>
			</div>
		</div>
